...
use crate::{cnl::network::object_entry_object::ObjectEntryEvent, state::cnl_state::CNLState, notification::NotificationStream};
...
pub async fn request_object_entry_value(
    ...
    NotificationStream::new(&app_handle).notify_error("Unimplemented", "request object entry value is not yet implemented");
